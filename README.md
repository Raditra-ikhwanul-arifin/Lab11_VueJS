...
![Tabel Kategori](image/database.png)
...
![Artikel](image/deletartikel.png)
...
![Artikel](image/SortirArtikel.png)

🖼️ _Screenshot Tampilan Artikel Berdasarkan Kategori Teknologi :_

![Artikel](image/SortirArtikel2.png)
...
🖼️ _Screenshot Tampilan folder `public/assets/js/jquery-3.7.1.min.js` :_
...
## ![dashboard admin](image/adminportal1.png)

**Coba cari berdasarkan judul**

![Tabel Kategori](image/sortiradminportal.png)

---

**Coba fitur sorting (mengurutkan artikel berdasarkan kategori, urutkan A-Z.)**
![Tabel Kategori](image/sortiralphabet.png)

---

**Coba klik Pagination**
![Tabel Kategori](image/adminportal2.png)
...
![Postman Install](image/postmendwnlod.png)
...
![Postman Routes](image/shelroutes.png)
...
![Postman Routes](image/postmen1.png)
...
![REST API Semua Data](image/post2.png)
...
![REST API Semua Data](image/post3.png)
...
isi: Isi Artikel ke 7 ditambah melalui API by Raditra

📸 Screenshot:

![REST API Semua Data](image/post4.png)
...
URL: http://localhost:8080/post/8

Body: x-www-form-urlencoded

judul: Judul Artikel 8

isi: Isi Artikel ke 8 ditambah melalui API by Raditra

📸 Screenshot:

![REST API Semua Data](image/post5.png)
...
![REST API Semua Data](image/post6.png)
...
![Direktori lab8_vuejs](image/post7.png)
...
**Daftar Artikel**
![Daftar Artikel](image/VueJSdaftarartikel.png)

**Menambah data**
![Menambah Data](image/VueJStambahartikel.png)

**Mengedit data**
![Mengedit Data](image/VueJSEdit.png)

**Menghapus data**
![Menghapus Data](image/VueJSdelete.png)
